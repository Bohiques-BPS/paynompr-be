...
def queryForm943(company_id, year, period):
    ...
    try:
        ...
        # Calculate total
        total_wages = amount_varios_number.wages + amount_varios_number.commissions + amount_varios_number.concessions + amount_varios_number.bonus + amount_varios_number.tips
